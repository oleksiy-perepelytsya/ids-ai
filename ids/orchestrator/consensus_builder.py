...
class ConsensusBuilder:
    ...
    def merge_cross_scores(
        self,
        generalist_cross: CrossScore,
        agent_responses: List[AgentResponse]
    ) -> MergedCross:
        """
        Merge CROSS scores from Generalist and all agents.
        
        Args:
            generalist_cross: Generalist's CROSS score
            agent_responses: All specialized agent responses
            
        Returns:
            Merged CROSS scores
        """
        # Collect all scores (including Generalist)
        all_scores = [generalist_cross] + [r.cross_score for r in agent_responses]
        
        # Use MergedCross factory method
        merged = MergedCross.from_scores(all_scores)
